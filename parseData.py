...
#(fluxo['Código da Unidade Federativa do Curso'] == COD_ESTADOS['RS']) &
...
dfFinal.to_csv(f'arquivosCSV/bolsas_vs_desist/BR/bolsas_vs_desist-{ANO_INGRESSO}-BR.csv', encoding='cp1252', sep=';')
