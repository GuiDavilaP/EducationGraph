...
def parse_data(ano_ingresso, estado):
    ...
    fluxo = fluxo[
        (fluxo['Código da Unidade Federativa do Curso'] == COD_ESTADOS[estado]) &
    ...
    dfFinal.to_csv(f'arquivosCSV/bolsas_vs_desist/{estado}/bolsas_vs_desist-{ano_ingresso}-{estado}.csv', encoding='cp1252',
                   sep=';')
